...
class Settings(BaseSettings):
    ...
    # NOTE: the third var this integration needs, ``supabase_service_role_key``, is declared once
    # above (shared with the LINE Login bridge); ``services/line_store`` uses it to bypass RLS.
