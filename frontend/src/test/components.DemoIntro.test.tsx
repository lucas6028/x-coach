...
describe("DemoIntro", () => {
  it("shows the heading", () => {
    renderWithProviders(
      <DemoIntro onFile={vi.fn()} onOpenLibrary={vi.fn()} loading={false} statusMsg="" error="" />
    );
  ...
  it("calls onOpenLibrary when the sample button is clicked", async () => {
    ...
    renderWithProviders(
      <DemoIntro onFile={vi.fn()} onOpenLibrary={onOpenLibrary} loading={false} statusMsg="" error="" />
    );
  ...
  it("disables the sample button while loading", () => {
    renderWithProviders(
      <DemoIntro onFile={vi.fn()} onOpenLibrary={vi.fn()} loading={true} statusMsg="Processing…" error="" />
    );
