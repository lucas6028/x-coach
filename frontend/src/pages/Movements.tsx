...
import { MOVEMENT_GROUPS, isAnalyzable } from "../lib/movements";
...
// analyse are actionable (see ANALYZABLE_MOVEMENTS); the rest are listed but inert, so the menu
              ...
              <section key={group.key}>
                ...
                <ul className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  {group.items.map((movement, i) => {
                    const live = isAnalyzable(movement);
                        ...
                        {live ? (
                          ...
                          >
                            ...
                            <span className="min-w-0 flex-1">
                              <span className="block truncate font-medium text-content">{name}</span>
