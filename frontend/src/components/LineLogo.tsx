...
//
// Shared by the login page's "sign in with LINE" button and the admin LINE-integration page.
// `aria-hidden` is deliberate and load-bearing: every place this renders already has adjacent
// text naming LINE, so exposing the mark would double the accessible name of its heading/button.
export default function LineLogo({ size = 22 }: { size?: number }) {
  return (
