    ...
    >
      ...
      <div className="relative overflow-hidden bg-black" style={{ aspectRatio: "1.72 / 1" }}>
        ...
        <button
          ...
          className="absolute right-4 top-4 z-20 flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-[#3a3d4d]/90 text-white shadow-[0_10px_24px_rgba(20,24,60,0.28)] transition-colors hover:bg-[#2a2d3d]"
        >
          <CornersOut size={16} />
        </button>
        ...
        {/* Bottom control pill. */}
        <div className="absolute inset-x-3 bottom-3 z-20 flex items-center gap-3 rounded-full border border-white/10 bg-[#373a4a]/92 px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_10px_28px_rgba(0,0,0,0.32)]">
          <button
            onClick={togglePlay}
            aria-label={playing ? t("a11y.pause") : t("a11y.play")}
