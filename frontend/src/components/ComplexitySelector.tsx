        ...
        >
          <div className="p-4">
            ...
            <div className="relative mt-4 h-9">
              <div className="absolute inset-x-0 top-1/2 h-5 -translate-y-1/2 rounded-full bg-track/50" />
              ...
              <div className="absolute inset-y-0 left-3.5 right-3.5">
                <div
                  className={`absolute top-1/2 -left-3.5 h-5 -translate-y-1/2 rounded-full bg-primary ${
                    dragging ? "" : "transition-[width] duration-150 ease-out"
                  }`}
                  style={{ width: `calc(${pct}% + 0.875rem)` }}
                />
                {TIERS.map((tier, i) => (
                  <span
                    key={tier}
                ...
                <div
                  className={`absolute top-1/2 h-7 w-7 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-primary bg-white shadow-card ${
