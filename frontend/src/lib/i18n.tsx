...
const en: Dict = {
  ...
  "detail.mistakesSub":
    "The faults the knowledge graph defines for this movement. Open one for its causes, risks and corrective cues.",
  "detail.mistakesEmpty":
    "The knowledge graph has no faults authored for this movement yet.",
  "detail.mistakesError": "Couldn't load the fault list.",
  "detail.mistakesLinks": "{n} linked concepts",
  "detail.mistakesLink": "1 linked concept",
...
const zhHant: Dict = {
  ...
  "detail.mistakesSub": "知識圖譜為這個動作整理的常見問題。展開任一項即可查看成因、風險與修正提示。",
  "detail.mistakesEmpty": "知識圖譜還沒有為這個動作建立錯誤資料。",
  "detail.mistakesError": "無法載入錯誤清單。",
  "detail.mistakesLinks": "{n} 個關聯概念",
  "detail.mistakesLink": "1 個關聯概念",
