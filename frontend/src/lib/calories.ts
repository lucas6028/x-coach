...
export type GameId = "sixseven" | "ninja" | "blast";
...
export const EFFORT: Record<GameId, GameEffort> = {
  ...
  // Meme Blaster: big charge-and-fling arm throws, fewer per minute than a slice. `moves` = orbs
  // blasted, and each blast is a whole-body movement, so the ceiling is reached at a lower rate.
  blast: { floorMet: 2.5, peakMet: 5.5, movesForPeakPerMin: 45 },
};
