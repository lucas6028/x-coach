...
x-coach 是一個可解釋運動指導回饋的研究原型。它以一張涵蓋 16 個動作的生物力學知識圖譜為底，把影像感知、規則式生物力學檢查、輕量分類器，以及對專案知識的本地檢索串起來，讓畫面上的視覺訊號能變成講得出理由的教練回饋。（影片分析目前涵蓋 16 個動作中的 14 個，全部標為 Beta；知識圖譜與 app 內的動作瀏覽涵蓋全部 16 個。）
...
- 用可解釋的姿態規則偵測 14 個動作的動作問題（深蹲、過頭推舉、伏地挺身、弓步、硬舉、划船、彈力帶擴胸、二頭彎舉、手臂外展、手臂 VW、仰臥起坐、臀橋、腿部外展、軀幹旋轉）。所有偵測器皆標為 Beta；開合跳與高抬腿有偵測器但刻意不註冊，因為在標註資料上沒有任何一條規則有訊號。
...
把視覺訊號、結構化的生物力學知識與檢索式的建議連起來，做出講得出理由的教練回饋——目前以規則分析 14 個動作，底下是一張涵蓋 16 個動作的生物力學知識圖譜。
