...
**表 2　深蹲規則與 Fitness-AQA 標註的比對，n = 1,623，全視角合併。精確率、召回率與特異度可由本表推得，文中直接引用。**

| 規則 | 骨架 | TP | FP | FN | 平衡準確率 | 區段 IoU |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| knees_forward | MediaPipe | 1 | 0 | 1108 | 0.500 | 0.000 |
| knees_forward | RTMPose | 5 | 0 | 1104 | 0.502 | 0.001 |
| knees_inward | MediaPipe | 79 | 185 | 153 | 0.604 | 0.045 |
| knees_inward | RTMPose | 116 | 397 | 116 | 0.607 | 0.055 |
