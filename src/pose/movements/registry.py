...
def list_detectors() -> list[MovementDetector]:
    ...
    Sit-up, Shoulder Bridge, Leg Abduction, Torso Twist, Jumping Jacks, High Knee) --
    deterministic, and it puts the
...
from src.pose.movements import jumping_jacks  # noqa: E402,F401
from src.pose.movements import high_knee  # noqa: E402,F401
# Jumping Jacks and High Knee were deliberately left unimported (unregistered) from 2026-08 until
# 2026-09-26, while every rule of theirs was silent or withdrawn. The full EgoExo-Fitness archive
# woke one rule in each (jj_incomplete_leg_rom at the spec's 1.3; hk_insufficient_knee_lift at a
# data-derived 65.6 deg) and the user registered both. notes/egoexo-silent-rules-full-archive.md.
#
# That makes all 16 designed movements registered.
